...
import bashan.adoptme.AdoptMeApp;
import bashan.adoptme.config.Constants;
import bashan.adoptme.config.audit.AuditEventConverter;
import bashan.adoptme.domain.PersistentAuditEvent;
...
@SpringBootTest(classes = AdoptMeApp.class)
@Transactional
