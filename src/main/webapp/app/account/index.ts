...
export * from './adoptions-thumbnails/adoptions-thumbnails.component';
export * from './my-adoptions/my-adoptions.component';
export * from './my-adoptions/my-adoptions.route';
export * from './my-favorites/my-favorites.component';
export * from './my-favorites/my-favorites.route';
