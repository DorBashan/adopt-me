...
@Injectable()
export class LikesMySuffixPopupService {
        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.likesService.find(id).subscribe((likes) => {
                    this.ngbModalRef = this.likesModalRef(component, likes);
                    resolve(this.ngbModalRef);
                });
            } else {
                // setTimeout used as a workaround for getting ExpressionChangedAfterItHasBeenCheckedError
                setTimeout(() => {
                    this.ngbModalRef = this.likesModalRef(component, new LikesMySuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    likesModalRef(component: Component, likes: LikesMySuffix): NgbModalRef {
