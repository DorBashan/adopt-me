...
import bashan.adoptme.repository.AuthorityRepository;
import bashan.adoptme.config.Constants;
import bashan.adoptme.repository.UserRepository;
import bashan.adoptme.security.AuthoritiesConstants;
import bashan.adoptme.security.SecurityUtils;
import bashan.adoptme.service.util.RandomUtil;
...
public class UserService {
    ...
    public UserService(UserRepository userRepository, PasswordEncoder passwordEncoder,
                       AuthorityRepository authorityRepository, AdoptMeUserRepository adoptMeUserRepository) {
    ...
    public User createUser(String login, String password, String firstName, String lastName, String email,
        String imageUrl, String langKey, String location, String phone) {
        ...
        adoptMeUser.setUser(newUser);
        adoptMeUser.setLocation(location);
        adoptMeUser.setPhone(phone);
        adoptMeUserRepository.save(adoptMeUser);
        //userExtraSearchRepository.save(newUserExtra);
        log.debug("Created Information for UserExtra: {}", adoptMeUser);
